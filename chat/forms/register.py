...
tailwindcss_classes_register_form = 'w-full px-4 py-2 mt-1 bg-slate-800 text-white rounded-lg border border-slate-600 focus:ring-1 focus:ring-teal-400 focus:outline-none'
